...
class HookLine(Base):
    ...
    doors_door_type_name = Column('door_type_name',String(50), ForeignKey('doors.door_type_name'), primary_key=True, nullable=False)
    doors_rooms_num = Column('rooms_num',Integer, ForeignKey('doors.rooms_num'), primary_key=True, nullable=False)
    doors_rooms_buildings_name = Column('building_name',String(50), ForeignKey('doors.rooms_buildings_name'), primary_key=True, nullable=False)
