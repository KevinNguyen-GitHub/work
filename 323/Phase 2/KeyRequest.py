...
class KeyRequest(Base):
    ...
    rooms_buildings_name = Column('rooms_buildings_name', Integer, ForeignKey('rooms.buildings_name'), primary_key=True,
                                  nullable=False)
    ...
    copy_keys_is_loss = Column("copy_keys_is_loss", Boolean, ForeignKey('copy_keys.is_loss'), primary_key=True,
                               nullable=False)
